...
// Updated GoalPlanner With Edit Functionality
'use client';
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-10 font-sans">
      ...
      >
        ...
        <div className="flex items-center gap-2 border p-2 rounded">
          <Pencil size={18} className="text-gray-500" />
          <input className="w-full outline-none" placeholder="Goal name"
            value={formData.name}
        ...
        <div className="flex items-center gap-2 border p-2 rounded">
          <Wallet size={18} className="text-gray-500" />
          <input className="w-full outline-none" type="number" placeholder="Target amount"
        ...
        <div className="flex items-center gap-2 border p-2 rounded">
          <Tag size={18} className="text-gray-500" />
          <input className="w-full outline-none" placeholder="Category"
